...
const experienceLabel = (committee: string) => {
  switch (committee) {
    ...
    default:
      return "What qualities and experience could you contribute to KTH Developer? *";
  }
};
...
export default function ApplyForm() {
  ...
  const onSubmit = async (data: JoinFormValues) => {
    try {
      ...
      toast({
        ...
        description:
          "Thanks for your interest in KTH Developer. We'll get back to you shortly.",
      });
      form.reset();
    } catch {
      toast({
  ...
  return (
    <SectionRow id="join" index="02" label="Join" meta="APPLY">
      <div className="text-center max-w-4xl mx-auto">
        <h2 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight">
          Apply to{" "}
          <span className="text-gradient-red">KTH Developer</span>
        </h2>
      </div>

      <div className="mt-16 -mx-5 sm:-mx-10 border-t border-white/15">
        <div className="p-8 sm:p-10">
          <p className="text-lg text-muted-foreground leading-relaxed text-left">
            Help shape KTH Developer from day one. Pick where you fit:{" "}
            <strong>Operations</strong> (media, branding, events, partnerships, facilities),{" "}
            <strong>Development</strong> (frontend, backend, infrastructure, self-hosting, security),
      ...
      <div className="-mx-5 sm:-mx-10 -mb-16 sm:-mb-24 border-t border-white/15">
        <div className="p-6 md:p-10">
          <div className="p-6 md:p-10 max-w-3xl mx-auto [&_input]:border-primary/40 [&_textarea]:border-primary/40 [&_button[role=combobox]]:border-primary/40 [&_input]:bg-transparent [&_textarea]:bg-transparent [&_button[role=combobox]]:bg-transparent [&_input:focus-visible]:border-primary [&_textarea:focus-visible]:border-primary [&_button[role=combobox]:focus]:border-primary">
          <Form {...form}>
            <form
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="space-y-3">
                        <FormLabel>
                          Which part of KTH Developer interests you? *
                        </FormLabel>
                        <FormControl>
                          <RadioGroup
